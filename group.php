  ...
  <div class="col-md-12">
    ...
    <div class="panel-heading clearfix">
      <strong>
       ...
       <a href="add_group.php" class="btn btn-info pull-right btn-sm" disabled> Add New Group</a>
    </div>
          ...
          <?php endif;?>
           ...
           <td class="text-center">
             <div class="btn-group">
                ...
                <a href="delete_group.php?id=<?php echo (int)$a_group['id'];?>" class="btn btn-xs btn-danger" data-toggle="tooltip" title="Remove" disabled>
